  ...
  if (!mounted) {
    return (
      <Button
        ...
        // buttonVariants と重複するクラスを削除し、カスタムスタイルのみ残す (もしあれば)
        // 今回は theme-toggle 固有のカスタムクラスはなさそうなので className 自体を削除、または必要なカスタムクラスのみ指定
        // 例: className="border-gold-500" のようにカスタムスタイルのみ指定
        // 以下の例では、重複クラスを削除し、カスタムクラスがないため className を削除
