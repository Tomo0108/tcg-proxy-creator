        ...
        <Card>
          <CardContent className="p-6">
            ...
            <div
              ...
              style={{
                width: `${width * 3}px`, // Adjust multiplier for desired preview size
                height: `${height * 3}px`,
              }}
            >
              {uploadedImage ? (
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="flex items-center gap-2 mt-2">
                  <Input
                    id="image-scale" type="range" min="0.1" max="3" step="0.01" // Changed to range slider
                    value={imageScale}
          ...
          <CardContent className="p-6">
            ...
            <div className="bg-gray-100 dark:bg-gray-800 p-2 rounded-lg overflow-hidden">
              ...
              >
                ...
                {/* Overlay Grid for Interaction */}
                <div
                  className="absolute top-0 left-0 w-full h-full z-10"
                  style={{
                    paddingLeft: `${(marginX / a4Width) * 100}%`, // Use percentage for positioning relative to container
            <h3 className="text-lg font-medium mb-4">{t("editor.cardPreview")}</h3>
