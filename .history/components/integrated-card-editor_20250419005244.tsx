...
export function IntegratedCardEditor({
  ...
  const mmToPixels = useCallback((mm: number) => {
    ...
    // Return the calculated pixel value, potentially rounding for consistency
    return mm * scale; // Keep as float for potentially higher precision in layout? Or round here? Let's try keeping float first.
