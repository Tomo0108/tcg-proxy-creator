...
import { Suspense, useState, useEffect, useMemo } from "react"; // Added useMemo
import * as THREE from "three";
import { EffectComposer } from "@react-three/postprocessing";
import { MotionBlurEffect } from "postprocessing"; // Import effect from postprocessing
    ...
    <div style={{ position: 'fixed', top: 0, left: 0, width: '100%', height: '100%', zIndex: -1, pointerEvents: 'none' }}>
      ...
      >
        ...
        <EffectComposer>
          ...
          {/* Use MotionBlurEffect directly */}
          {/* Effects often need to be memoized */}
          {useMemo(() => <primitive object={new MotionBlurEffect({ intensity: 0.5 })} attach="passes" />, [])}
        </EffectComposer>
      </Canvas>
    </div>
  );
