  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-6">
        <Card className="col-span-1 border-gold-500"> {/* Added gold border */}
          <CardContent className="p-6">
            ...
            <div className="mt-6 space-y-4">
              {/* Removed Quality select from here */}
              <div className="flex flex-col sm:flex-row justify-end items-center gap-4">
                <div className="flex space-x-2 justify-end w-full sm:w-auto">
                  ...
                  {/* PNG Button */}
                  <Button variant="outline" onClick={handleExportPNG} disabled={isExporting || containerWidth <= 0} className="border-gold-500 text-gold-500 hover:bg-gold-500 hover:text-primary-foreground flex-1 sm:flex-none sm:w-28">
                    <Download className="mr-2 h-4 w-4" /> PNG
                  </Button>
                  {/* PDF Button */}
                  <Button variant="outline" onClick={handleExportPDF} disabled={isExporting || containerWidth <= 0} className="border-gold-500 text-gold-500 hover:bg-gold-500 hover:text-primary-foreground flex-1 sm:flex-none sm:w-28">
