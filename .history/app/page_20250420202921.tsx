          ...
          <div className="container px-4 md:px-6 relative z-10"> {/* Changed z-20 back to z-10 */}
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center relative"> {/* Removed z-10 */}
              ...
              <div className="space-y-2">
                {/* Force white text for title - Adjusted responsive font sizes */}
                <h2 className="text-2xl font-bold tracking-tighter sm:text-3xl md:text-4xl lg:text-5xl text-gray-50">{t("home.hero.title")}</h2> {/* Base size smaller */}
                {/* Force lighter gray text for description - Centered text and adjusted responsive font sizes */}
                <p className="max-w-[90%] sm:max-w-[700px] text-center text-sm text-gray-300 sm:text-base md:text-lg lg:text-xl">{t("home.hero.description")}</p> {/* Centered, base size smaller, max-width adjusted */}
              </div>
