             ...
             <Card className="border-gold-500 mt-6"> {/* Added gold border and margin */}
               <CardContent className="p-6">
                 ...
                 <div className="space-y-4">
                   {/* Export Scope Toggle */}
                   <div>
                     <Label htmlFor="export-scope">{t("export.scope")}</Label> {/* Use the added translation key */}
                     <ToggleGroup
                       id="export-scope"
                       type="single"
                       value={exportScope}
                     ...
                     >
                       <ToggleGroupItem value="current" aria-label={t("export.scope.current")}> {/* Use correct key */}
                         {t("export.scope.current")} {/* Use correct key */}
                       </ToggleGroupItem>
                       <ToggleGroupItem value="all" aria-label={t("export.scope.all")}> {/* Use correct key */}
                         {t("export.scope.all")} {/* Use correct key */}
                       </ToggleGroupItem>
                     </ToggleGroup>
                   </div>

                   {/* Export Buttons */}
                   <div className="grid grid-cols-1 sm:grid-cols-3 gap-2"> {/* Removed mt-4 */}
                     <Button
