    ...
    <div style={{ position: 'fixed', top: 0, left: 0, width: '100%', height: '100%', zIndex: -1, pointerEvents: 'none' }}>
      ...
      >
        ...
        <EffectComposer>
          ...
          {/* Use DepthOfFieldEffect directly */}
          {/* Need camera prop for DepthOfFieldEffect */}
          {useMemo(() => {
            // @ts-ignore - camera might not be directly available here, needs ref or context
            const camera = (window as any).__R3F__.root.camera;
            return <primitive object={new DepthOfFieldEffect(camera, { focusDistance: 0.0, focalLength: 0.03, bokehScale: 2.0, height: 480 })} attach="passes" />;
          }, [])}
        </EffectComposer>
      </Canvas>
    </div>
