...
// Import RealisticMotionBlur instead
import { EffectComposer, RealisticMotionBlur } from "@react-three/postprocessing";
    ...
    <div style={{ position: 'fixed', top: 0, left: 0, width: '100%', height: '100%', zIndex: -1, pointerEvents: 'none' }}>
      ...
      >
        ...
        <EffectComposer>
          ...
          {/* Add RealisticMotionBlur */}
          <RealisticMotionBlur
            intensity={0.3} // Adjust intensity (default 0.5)
            luminanceThreshold={0.1} // Adjust luminance threshold (default 0.1)
            luminanceSmoothing={0.025} // Adjust luminance smoothing (default 0.025)
          />
        </EffectComposer>
      </Canvas>
    </div>
