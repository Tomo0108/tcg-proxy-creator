                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <Select value={exportQuality} onValueChange={(value) => setExportQuality(value as any)}>
                      ...
                      <SelectContent>
                        <SelectItem value="standard">標準 / Standard (300 DPI)</SelectItem>
                        <SelectItem value="high">高品質 / High (450 DPI)</SelectItem>
                        <SelectItem value="ultra">超高品質 / Ultra (600 DPI)</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
