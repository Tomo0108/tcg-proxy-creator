          ...
          <CardContent className="p-6">
                  ...
                  >
                    ...
                    {Array(cardsPerRow * cardsPerColumn)
                      ...
                      .map((_, index) => (
                        <div
                          key={index}
                          className={`relative border border-dashed border-gray-500 dark:border-gray-600 rounded cursor-pointer transition-all hover:bg-gray-100/50 dark:hover:bg-gray-800/50 ${ // Added relative, changed border color
                            selectedCardIndex === index ? "ring-2 ring-gold-500 ring-offset-1" : ""
                          }`}
            ...
            <div className="mt-6 space-y-4">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <div className="flex space-x-2 justify-end w-full sm:w-auto"> {/* Ensure buttons are always in a row, adjust width for responsiveness */}
