               ...
               <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                ...
                >
                 ...
                 <div className="flex flex-col sm:flex-row items-center justify-end gap-2 w-full sm:w-auto">
                   ...
                   >
                     <ToggleGroupItem value="current" aria-label="Export current page" className="data-[state=on]:bg-gold-500 data-[state=on]:text-black dark:data-[state=on]:text-white px-3 text-xs sm:text-sm h-full">
                       {t("export.scope.current")}
                     </ToggleGroupItem>
                     <ToggleGroupItem value="all" aria-label="Export all pages" className="data-[state=on]:bg-gold-500 data-[state=on]:text-black dark:data-[state=on]:text-white px-3 text-xs sm:text-sm h-full">
                       {t("export.scope.all")}
                     </ToggleGroupItem>
                   </ToggleGroup>
