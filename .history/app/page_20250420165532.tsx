          ...
          <div className="container px-4 md:px-6 relative z-10"> {/* Changed z-20 back to z-10 */}
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center relative"> {/* Removed z-10 */}
              ...
              <div className="space-y-2">
                ...
                {/* Force lighter gray text for description - Adjusted responsive font sizes and max-width */}
                <p className="mx-auto max-w-[90%] sm:max-w-[700px] text-base text-gray-300 md:text-lg lg:text-xl">{t("home.hero.description")}</p> {/* Base size smaller, max-width adjusted */}
              </div>
