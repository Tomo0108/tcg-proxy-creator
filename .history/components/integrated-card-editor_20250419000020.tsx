        ...
        <Card>
          <CardContent className="p-6">
            ...
            <div className="mt-6 space-y-4">
              <div className="flex flex-col sm:flex-row justify-end items-center gap-4"> {/* Removed justify-between, only justify-end needed now */}
                {/* DPI Selection moved to Card Editor */}
