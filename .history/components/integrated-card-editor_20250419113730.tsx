    ...
    const loadPromises = cards.slice(0, cardsPerRow * cardsPerColumn).map((card, index) => {
      ...
      return new Promise<void>((resolve) => {
        ...
        img.onload = () => {
          ...
          let baseWidth, baseHeight; // 修正: 重複宣言を削除
            ...
            <div className="bg-gray-100 dark:bg-gray-800 p-2 rounded-lg overflow-hidden">
              <div
                ...
                style={{
                  ...
                  boxShadow: "0 4px 6px rgba(0, 0, 0, 0.1)", overflow: "hidden", // 修正: カンマ追加
              ...
              >
                <canvas
                  ...
                  style={{ padding: 0, border: 'none', margin: 0, display: 'block' }} // 修正: カンマ追加
                />
                  ...
                  >
                    <div className="grid h-full w-full" style={gridStyles}>
                      <Input
                        ...
                        onChange={(e) => handleFileChange(e, -1)} // 修正: カンマ追加
                      />
                      {Array(cardsPerRow * cardsPerColumn).fill(0).map((_, index) => ( // 修正: カンマ追加
                        <div
                          key={index}
                          className={cn(
                          ...
                          style={{ pointerEvents: "auto", touchAction: 'none' }} // 修正: カンマ追加
                        ...
                        >
                          <Input
                            ...
                            type="file" accept="image/*" className="hidden"
                            onChange={(e) => handleFileChange(e, index)} // 修正: カンマ追加
                          />
                          {cards[index] && (
                            <Button
