      ...
      <main className="flex-1">
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 relative overflow-hidden">
          ...
          <div className="container px-4 md:px-6 relative z-10">
             {/* Image moved here, positioned absolutely within the container, behind text */}
             <Image
               src="/img/penki_gold.png"
               alt="Gold paint splatter"
               layout="fill" // Use layout="fill" with absolute positioning
               objectFit="contain" // Use objectFit with layout="fill"
               className="absolute inset-0 z-5 pointer-events-none" // Positioned absolutely, behind text (z-10)
               priority
             />
            {/* Text container, implicitly above the image due to container's z-10 and image's z-5 */}
            {/* Add relative here to ensure text stays above */}
